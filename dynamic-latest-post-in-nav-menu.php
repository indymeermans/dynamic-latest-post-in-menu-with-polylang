<?php
/*
Plugin Name: Dynamic Latest Post in Nav Menu with Polylang
Plugin URI: http://hijiriworld.com/web/plugins/dynamic-latest-post-in-nav-menu/
Description: Add Custom Post Type's Dynamic Latest Post and Archive to Nav Menu with locale language.
Author: Indy Meermans
Author URI: http://indymeermans@hotmail.com
Version: 3.5.1
